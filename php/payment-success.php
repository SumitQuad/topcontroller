...
if(isset($_POST['id'])){
    ...
    {  
        ...
        $query = "UPDATE `inventory` SET `left_inventory` = `left_inventory` - 1 WHERE `product_name` = '$product_name' ";
        ...
        $body = file_get_contents('../email_template/email-template-1.html');
        ...
        $body = $body.$custom_string.file_get_contents('../email_template/email-template-2.html');
